...
public class MemberDTO {
	...
	public String toString() {
		return "MemberDTO [member_id=" + member_id + ", member_pwd=" + member_pwd + ", member_name=" + member_name
				+ ", member_nickname=" + member_nickname + ", member_zip1=" + member_zip1 + ", member_zip2="
				+ member_zip2 + ", member_addr1=" + member_addr1 + ", member_addr2=" + member_addr2
				+ ", member_regdate=" + member_regdate + ", member_state=" + member_state + ", member_delcont="
				+ member_delcont + ", member_deldate=" + member_deldate + "]";
	}
