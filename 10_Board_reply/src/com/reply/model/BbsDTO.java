...
public class BbsDTO {
	...
	public String toString() {
		return "BbsDTO [board_no=" + board_no + ", board_writer=" + board_writer + ", board_title=" + board_title
				+ ", board_cont=" + board_cont + ", board_pwd=" + board_pwd + ", board_date=" + board_date
				+ ", board_group=" + board_group + ", board_step=" + board_step + ", board_indent=" + board_indent
				+ "]";
	}
