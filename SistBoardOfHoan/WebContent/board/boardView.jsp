...
<!-- 	<input type="button" value="리스트" onClick="open_win('BoardServlet?command=board_list')">
	<input type="button" value="등록" onClick="open_win('BoardServlet?command=board_write_form')"> -->
