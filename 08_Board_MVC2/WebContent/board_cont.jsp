...
<body>
	<div align="center">
		...
		<form name="frm" action="<%=request.getContextPath() %>/board_update.do?no=${dto.getBoard_no()}" method="post">
				...
				<tr>
					<td colspan="2" align="center">
						...
						<input type="button" value="삭제" 
							onclick="location.href='<%=request.getContextPath() %>/board_delete.do?no=${dto.getBoard_no() }'"/>
							 &nbsp; &nbsp;	 
